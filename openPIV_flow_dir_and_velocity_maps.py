...
plot_every = 5
plt.quiver(x[::plot_every,::plot_every],y[::plot_every,::plot_every],u[::plot_every,::plot_every],v[::plot_every,::plot_every], linewidth = 2)

plt.figure()
plt.quiver(x[::plot_every,::plot_every],y[::plot_every,::plot_every],u[::plot_every,::plot_every],v[::plot_every,::plot_every], color, norm = colors.SymLogNorm(linthresh = np.amin(5),linscale=1, vmin=0, vmax=230), headwidth = 3, headlength = 5, headaxislength = 4) 
