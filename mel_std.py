...
mel_1=[]        #melange velocity spot list
mel_2=[]
t_start = []    #time start
t_end = []      #time end
flist= []       #files list in directories
medians=[]      #medians of atmospheric noise
std=[]          #standard deviation of atmospheric noise
q1=[]           #interquartile range of atmospheric noise (25th percentile)
q2=[]           #interquartile range of atmospheric noise (50th percentile)
q3=[]           #interquartile range of atmospheric noise (75th percentile)
iqr = []        #interquartile range 75th - 25th percentile
std_close=[]    #melange close to terminus
std_far=[]      #melange far away from terminus
q1=[]
q2=[]
q3=[]
iqr = []
